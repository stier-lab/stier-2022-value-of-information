...
#and creates a large array to sample for figure 1
#the goal is to have data to visualize how combinations of
#monitoring and fishing pressure influence risk of tipping and Net Presetn Value
#########
