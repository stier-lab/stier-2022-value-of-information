msetwd("~/Dropbox/Projects/In Progress/Value of Information/Code/Value of Information")

library(reshape2)
library(ggplot2)

#load
source("theme_Publication.R") #graphing hack 1
source("multiplot.R") #graphic hack 2
...
print(gga)
ggsave("dbdt.pdf",width=5,height=2)
