...
#set directory
setwd("/Users/AdrianStierMBP2015/Dropbox/Projects/In Progress/Value of Information/Code/") #ACS Laptop
...
source("theme_acs.R") #plotting fuction
...
load("precautionary_buffer.Rdata")
...
gsmooth<-ggplot(temp3b,aes(x=mf,y=ratio))+
