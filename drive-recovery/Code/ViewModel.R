...
model.output.lowCV<-est.NPV(years,K,A,r,phi.CV.low=0.1,phi.CV.high=0.1,delta,process.noise,p,B.start,B.lim,B.crit,max.F,phi.CV.seed,process.noise.seed)
model.output.lowCV<-est.NPV(years,K,A,r,phi.CV.low=0.5,phi.CV.high=0.5,delta,process.noise,p,B.start,B.lim,B.crit,max.F,phi.CV.seed,process.noise.seed)
...
lines(1:20,model.output.lowCV$Bhat,lwd=2,col="black")
...
lines(1:20,model.output.highCV$Bhat,lwd=2,col="black")
